...
public class TutorialAutoBase {
	public static void main(String[] args) {
		...
		db.openConnection();
		AutoBaseExemplo teste = new AutoBaseExemplo();
	...
	public static class AutoBaseExemplo implements AutoBase<AutoBaseExemplo> {
		...
		public String toString() {
			...
			return "MeuObjeto [id=" + id + ", nome=" + nome + ", uuid=" + uuid + ", duplo=" + duplo + ", flutuante="
					+ flutuante + ", carro=" + carro + ", longo=" + longo + ", bit=" + bit + ", shorte=" + shorte
					+ ", dia=" + dia + ", datetime=" + datetime + ", time=" + time + ", calendario=" + calendario
					+ ", diautil=" + diautil + "]";
		}
